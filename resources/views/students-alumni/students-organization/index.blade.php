...
<body>
    <div class="wrapper-all w-full min-h-screen bg-[#F7FFFA] relative">
        <x-navbar />
        <div class="main-organization flex flex-col pt-16">
            <div
                ...
                <div class="header-top flex items-end gap-3">
                    <h1 class="text-5xl font-medium">Student Organization</h1>
            ...
            <div class="organization fade-in py-10 px-28 flex flex-col gap-10 bg-[#F7FFFA]">
                <div class="w-full flex flex-col gap-5">
                    <div class="list-fc w-full flex flex-col gap-7">
                        <x-link-card-small title="Badan Eksekutif Mahasiswa (BEM)"
                            href="https://google.com" />
                        <x-link-card-small-last title="Badan Legislatif Mahasiswa (BLM)"
                            href="https://google.com" />
                    </div>
                </div>
            </div>
