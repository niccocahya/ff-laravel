...
<body>
    <div class="wrapper-all w-full min-h-screen bg-[#F7FFFA] relative">
        <x-navbar />
        <div class="main-student flex flex-col pt-16">
            <div
                ...
                <div class="header-top flex items-end gap-3">
                    <h1 class="text-5xl font-medium">Student Information</h1>
            ...
            <div class="student fade-in py-10 px-28 flex flex-col gap-10 bg-[#F7FFFA]">
                <div class="w-full flex flex-col gap-5">
                    <div class="list-fc w-full flex flex-col gap-7">
                        <x-link-card-small title="Student Activity"
                            href="https://google.com" />
                        <x-link-card-small title="Student Achievement"
                            href="https://google.com" />
                        <x-link-card-small title="Scholarship"
                            href="https://google.com" />
                        <x-link-card-small-last title="Resignation Procedure"
                            href="https://google.com" />
                    </div>
                </div>
            </div>
