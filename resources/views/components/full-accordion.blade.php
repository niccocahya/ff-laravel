...
<div class="w-full flex flex-col gap-2 md:gap-3 items-center" id="accordion-{{ $id }}">
 ...
 >
     <div class="w-full md:w-[70%] lg:w-[40%] flex flex-col gap-2 md:gap-3 pr-2 md:pr-0">
        <h3 class="text-lg md:text-xl lg:text-2xl font-medium text-gray-800">
          {{ $title }}
        </h3>
     </div>
     ...
     <svg 
        id="icon-{{ $id }}"
        class="w-8 h-8 md:w-10 md:h-10 lg:w-[44px] lg:h-[44px] shrink-0 transform transition-transform duration-300 mt-0.5 md:mt-0"
