...
<body>
    <div class="wrapper-all w-full min-h-screen bg-[#F7FFFA] relative">
        ...
        <div class="main-leadership flex flex-col pt-26">
            ...
            <div class="content-area fade-in px-4 sm:px-8 md:px-16 lg:px-28 py-10 sm:py-12 md:py-16 flex flex-col gap-10 sm:gap-12 md:gap-16 bg-white">

                <div class="flex flex-col gap-4">
                    <h2 class="text-neutral-950 text-3xl sm:text-4xl md:text-[40px] font-medium tracking-[-0.04em]">Study Program Profile</h2>
                ...
                <div class="flex flex-col gap-8 sm:gap-10">
                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-end gap-3 border-b pb-4 border-gray-100">
                        <h2 class="text-neutral-950 text-3xl sm:text-4xl md:text-[40px] font-medium tracking-[-0.04em]">Leader of Study Program</h2>
                        <div class="text-neutral-700 text-base sm:text-lg font-normal">2025-2030 Period</div>
                    </div>
                    ...
                    <div class="flex flex-col sm:flex-row justify-center gap-6">
                        ...
                        <div class="w-full max-w-[278px] h-[402px] mx-auto relative bg-gray-50 rounded-xl shadow-md overflow-hidden">
                ...
                <div class="flex flex-col gap-4">
                    <h2 class="text-neutral-950 text-3xl sm:text-4xl md:text-[40px] font-medium tracking-[-0.04em]">Background</h2>
                    <p class="text-justify text-neutral-700 text-base sm:text-lg font-normal leading-relaxed">
                ...
                <div class="flex flex-col gap-4">
                    <h2 class="text-neutral-950 text-3xl sm:text-4xl md:text-[40px] font-medium tracking-[-0.04em]">Vision</h2>
                    <p class="text-justify text-neutral-700 text-base sm:text-lg font-normal leading-relaxed">
                ...
                <div class="flex flex-col gap-4">
                    <h2 class="text-neutral-950 text-3xl sm:text-4xl md:text-[40px] font-medium tracking-[-0.04em]">Mission</h2>
                    <div class="text-justify text-neutral-700 text-base sm:text-lg font-normal leading-relaxed space-y-2">
                ...
                <div class="flex flex-col gap-4">
                    <h2 class="text-neutral-950 text-3xl sm:text-4xl md:text-[40px] font-medium tracking-[-0.04em]">Objective</h2>
                    <div class="text-justify text-neutral-700 text-base sm:text-lg font-normal leading-relaxed space-y-2">
                ...
                <div class="flex flex-col gap-4">
                    <h2 class="text-neutral-950 text-3xl sm:text-4xl md:text-[40px] font-medium tracking-[-0.04em]">Goals</h2>
                    <div class="text-justify text-neutral-700 text-base sm:text-lg font-normal leading-relaxed space-y-2">
                ...
                <section class="flex flex-col">
                    ...
                    <div class="mt-8">
                        ...
                        <div class="tab-content w-full bg-gray-50 rounded-xl shadow-[1px_2px_4px_0px_rgba(0,21,7,0.12)] overflow-hidden">
                            ...
                            <div class="w-full bg-[#275CAA] flex flex-col md:flex-row md:items-center px-4 sm:px-8 md:px-12 py-4 gap-2 md:gap-0 min-h-20">
                                <div class="w-full md:w-[350px] text-gray-50 text-xl sm:text-2xl font-medium">Informasi</div>
                                <div class="text-gray-50 text-xl sm:text-2xl font-medium">Keterangan</div>
                            </div>

                            <div class="flex flex-col">

                                <div class="flex flex-col md:flex-row md:items-center px-4 sm:px-8 md:px-12 py-6 gap-2 bg-gray-50 border-b border-gray-100">
                                    <div class="w-full md:w-[350px] text-neutral-700 text-base sm:text-lg font-normal">Gelar Lulusan</div>
                                    <div class="text-neutral-700 text-base sm:text-lg font-normal">???</div>
                                </div>

                                <div class="flex flex-col md:flex-row md:items-center px-4 sm:px-8 md:px-12 py-6 gap-2 bg-[#F8FAFC]">
                                    <div class="w-full md:w-[350px] text-neutral-700 text-base sm:text-lg font-normal">Pelaksanaan Program</div>
                                    <div class="text-neutral-700 text-base sm:text-lg font-normal">???</div>
                                </div>

                                <div class="flex flex-col md:flex-row md:items-center px-4 sm:px-8 md:px-12 py-6 gap-2 bg-gray-50 border-t border-gray-100">
                                    <div class="w-full md:w-[350px] text-neutral-700 text-base sm:text-lg font-normal">Pelaksanaan Perkuliahan</div>
                                    <div class="text-neutral-700 text-base sm:text-lg font-normal">???</div>
                                </div>

                                <div class="flex flex-col md:flex-row md:items-center px-4 sm:px-8 md:px-12 py-6 gap-2 bg-gray-50 border-b border-gray-100">
                                    <div class="w-full md:w-[350px] text-neutral-700 text-base sm:text-lg font-normal">Periode Penerimaan</div>
                                    <div class="text-neutral-700 text-base sm:text-lg font-normal">???</div>
                                </div>

                                <div class="flex flex-col md:flex-row md:items-center px-4 sm:px-8 md:px-12 py-6 gap-2 bg-[#F8FAFC]">
                                    <div class="w-full md:w-[350px] text-neutral-700 text-base sm:text-lg font-normal">Masa Studi</div>
                                    <div class="text-neutral-700 text-base sm:text-lg font-normal">???</div>
                                </div>

                                <div class="flex flex-col md:flex-row md:items-center px-4 sm:px-8 md:px-12 py-6 gap-2 bg-gray-50 border-t border-gray-100">
                                    <div class="w-full md:w-[350px] text-neutral-700 text-base sm:text-lg font-normal">Akreditasi</div>
                                    <div class="text-neutral-700 text-base sm:text-lg font-normal">???</div>
                                </div>
