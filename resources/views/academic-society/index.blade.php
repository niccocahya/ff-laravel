   ...
   <div class="wrapper-all w-full min-h-screen bg-[#F7FFFA] relative">
    ...
    <div class="main-home flex flex-col pt-16">
        ...
        <div class="px-28 py-10 flex gap-5 bg-[#F7FFFA]">
            <button class="px-6 py-2 rounded-full bg-[#275CAA] text-white text-sm hover:bg-[#1d4f96] transition-all duration-200">
                Department of Pharmacy Practice
            </button>
            <button class="px-6 py-2 rounded-full border border-[#275CAA] text-[#275CAA] text-sm hover:bg-[#275CAA] hover:text-white transition-all duration-200">
        ...
        <div class="px-28 flex flex-col">
            ...
            <div class="flex flex-col gap-5 text-justify text-sm leading-relaxed text-[#475569]">
                <p>
                    Based on the Instruction of the Minister of Higher Education and Science of the Republic of
                    Indonesia at the Conference of State University/Institute Presidents in August 1962, the
                    President of Airlangga University, through Decree No. Um/251/8/62 dated December 31, 1962,
                    formed a committee named “Committee for Investigating Efforts to Establish the Faculty of
                    Exact and Natural Sciences (FIPIA) at Airlangga University” with Prof. Ir. Soemardjo as
                    Chair and Drs. Marsoedi Soemohidjardjo as Secretary.
                </p>
                <p>
                    The committee was tasked with drafting a plan for the establishment of FIPIA at Airlangga
                    University, which consisted of four departments, namely the Department of Mathematics,
                    the Department of Physics, the Department of Biology, and the Department of Chemistry.
                    Long before that time, several senior educators at the Faculty of Medicine at Airlangga
                    University had come up with the idea of establishing a pharmaceutical education and public
                    health education institution with the aim of complementing the “Airlangga University
                    Medical Center” in connection with the existing Faculty of Medicine and Faculty of
                    Dentistry, which were located in a complex with a “teaching hospital,” namely Dr. Soetomo
                    General Hospital.
                </p>
            </div>
        </div>
        ...
        <div class="px-28 pb-32 py-20">
            <div class="flex justify-between items-center mb-12">
                <h1 class="text-3xl font-semibold text-[#1E293B]">
                    Head of Department
                </h1>
            ...
            <div class="flex justify-center gap-12">
                <div class="w-[280px] h-[420px] bg-white rounded-2xl shadow-lg overflow-hidden relative group cursor-pointer">
                    <img src="https://placehold.co/280x420/png?text=Andi+Hermansyah" alt="apt. Andi Hermansyah" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105">
                ...
                <div class="w-[280px] h-[420px] bg-white rounded-2xl shadow-lg overflow-hidden relative group cursor-pointer">
                    <img src="https://placehold.co/280x420/png?text=Dinda+Monika" alt="apt. Dinda Monika" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105">
                    <div class="absolute bottom-0 left-0 w-full h-48 bg-gradient-to-t from-black/80 via-black/40 to-transparent"></div>
                    <div class="absolute bottom-8 left-6 right-6 text-white text-left">
        ...
        <div id="content-community" class="fade-in block">
            ...
            <div class="px-28 pb-32 flex flex-col gap-3">
                ...
                <div class="flex flex-col gap-5 text-justify text-sm leading-relaxed text-[#475569]">
                    <p>
                        Based on the Instruction of the Minister of Higher Education and Science of the Republic of Indonesia 
                        at the Conference of State University/Institute Presidents in August 1962, the President of Airlangga 
                        University, through Decree No. Um/251/8/62 dated December 31, 1962, formed a committee named 
                        “Committee for Investigating Efforts to Establish the Faculty of Exact and Natural Sciences (FIPIA) 
                        at Airlangga University” with Prof. Ir. Soemardjo as Chair and Drs. Marsoedi Soemohidjardjo as Secretary.
                    </p>
                    <p>
                        The committee was tasked with drafting a plan for the establishment of FIPIA at Airlangga University, 
                        which consisted of four departments, namely the Department of Mathematics, the Department of Physics, 
                        the Department of Biology, and the Department of Chemistry. Long before that time, several senior 
                        educators at the Faculty of Medicine at Airlangga University had come up with the idea of establishing 
                        a pharmaceutical education and public health education institution with the aim of complementing 
                        the “Airlangga University Medical Center” in connection with the existing Faculty of Medicine and 
                        Faculty of Dentistry, which were located in a complex with a “teaching hospital,” namely Dr. Soetomo 
                        General Hospital.
                    </p>
                </div>
            </div>
            ...
            <div class="px-28 pb-12">
                ...
                <div class="flex justify-center">
                    <div class="relative w-[260px] h-[360px] rounded-2xl overflow-hidden shadow-xl group cursor-pointer">
                        <img src="https://placehold.co/260x360/png?text=Prof.+Umi" alt="Prof. Umi Athiyah" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105">
                        ...
                        <div class="absolute bottom-6 left-4 right-4 text-center text-white">
                            ...
                            <p class="text-[10px] mt-1 opacity-90 leading-tight">Community Pharmacy Scientific Field Group Coordinator</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div id="content-clinical" class="hidden fade-in">
            ...
            <div class="px-28 pb-12">
                ...
                <div class="flex justify-center">
                    <div class="relative w-[260px] h-[360px] rounded-2xl overflow-hidden shadow-xl group cursor-pointer">
                        <img src="https://placehold.co/260x360/png?text=Prof.+Budi" alt="Prof. Budi Suprapti" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent"></div>
                        <div class="absolute bottom-6 left-4 right-4 text-center text-white">
                            <h2 class="text-sm font-bold leading-tight">Prof. Dr. apt. Budi Suprapti, M.Si.</h2>
                            <p class="text-[10px] mt-1 opacity-90 leading-tight">Clinical Pharmacy Scientific Field Group Coordinator</p>
                        </div>
                    </div>
                </div>
            </div>
