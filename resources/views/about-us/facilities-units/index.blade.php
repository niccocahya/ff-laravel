...
<div class="wrapper-all w-full min-h-screen relative">
    ...
    <div class="main-home flex flex-col pt-16">
        ...
        <div class="fade-in block bg-[#F7FFFA]">
            ...
            {{-- Section: Video Tour --}}
            <section class="px-4 sm:px-8 md:px-16 lg:px-28 py-12 md:py-24 flex flex-col lg:flex-row gap-8 lg:gap-12 items-start justify-between">
                <div class="w-full lg:w-80 flex flex-col gap-4">
                    <h2 class="text-neutral-950 text-3xl md:text-4xl font-medium tracking-[-0.04em]">Facilities</h2>
                    <p class="text-neutral-700 text-base md:text-lg font-normal leading-relaxed text-justify">
                        Take a virtual tour through our advanced learning environment and state-of-the-art laboratories.
                    </p>
                </div>

                <div class="w-full lg:w-[823px] aspect-video relative rounded-2xl overflow-hidden shadow-xl bg-black">
            ...
            {{-- Section: Laboratory Grid --}}
            <section class="px-4 sm:px-8 md:px-16 lg:px-28 pb-16 md:pb-32 flex flex-col gap-8 md:gap-12">
                <div class="w-full flex flex-col sm:flex-row justify-between items-start sm:items-end border-b border-gray-100 pb-6 gap-2 sm:gap-0">
                    <h2 class="text-neutral-950 text-3xl md:text-[40px] font-medium tracking-[-0.04em]">Laboratory</h2>
                    <p class="text-neutral-700 text-sm md:text-lg font-normal">Supporting Education, Lectures and Research</p>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                    ...
                    <div onclick="openLabModal({{ json_encode($lab) }})" 
                         class="relative h-56 sm:h-60 md:h-64 bg-gray-50 rounded-xl shadow-[1px_2px_4px_0px_rgba(0,21,7,0.24)] overflow-hidden group cursor-pointer">
                        ...
                        <div class="absolute bottom-0 left-0 w-full p-4 md:p-6 flex flex-col gap-1">
                            <h3 class="text-gray-50 text-xl md:text-2xl font-bold font-['Lato'] tracking-tight">{{ $lab['name'] }}</h3>
                            <p class="text-gray-50 text-xs md:text-sm font-normal opacity-90 leading-snug">{{ $lab['short_desc'] }}</p>
                        </div>
                    </div>
                    @endforeach
                </div>
...
<div id="labModal" class="fixed inset-0 z-[100] hidden flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
    <div class="w-full max-w-[656px] max-h-[90vh] px-4 sm:px-6 py-5 bg-white rounded-lg flex flex-col gap-1.5 overflow-hidden shadow-2xl relative animate-fadeIn">
        
        <div class="self-stretch inline-flex justify-between items-center mb-2">
            <div id="modal-lab-id" class="text-neutral-700 text-sm sm:text-base font-bold font-['Lato'] uppercase">LAB 1</div>
            <button onclick="closeLabModal()" class="w-8 h-8 flex items-center justify-center hover:bg-gray-100 rounded-full transition-colors flex-shrink-0">
        ...
        <div class="overflow-y-auto modal-content-scroll flex flex-col gap-4 pr-1">
            <img id="modal-img" class="self-stretch h-48 sm:h-64 md:h-72 rounded-lg object-cover shadow-sm" src="" alt="Lab Detail">

            <div class="self-stretch flex flex-col gap-4">
                <div class="flex flex-col gap-3">
                    <div id="modal-full-title" class="self-stretch text-neutral-950 text-sm sm:text-base font-medium font-['Lato'] uppercase leading-snug">
                        TITLE
                    </div>
                ...
                <div class="flex flex-col gap-3 border-t border-gray-100 pt-4">
                    <div class="text-neutral-950 text-sm sm:text-base font-medium font-['Lato']">Penanggungjawab/Coordinator:</div>
