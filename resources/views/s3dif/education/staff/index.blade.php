    ...
    <div class="wrapper-all w-full min-h-screen bg-[#F7FFFA] relative font-sans">
        ...
        <div class="main-calendar flex flex-col pt-20 md:pt-26">
            ...
            <div class="fade-in py-8 md:py-14 px-6 md:px-16 lg:px-28 flex flex-col gap-6 md:gap-10 bg-[#F7FFFA]">
                ...
                <x-pagination-s3dif-education active="staff" />
                ...
                <div class="w-full flex flex-col gap-6 pt-2">
                    ...
                    <div class="tab-content fade-in block w-full mt-2">
                        ...
                        <div class="pb-6 md:pb-8 flex flex-col sm:flex-row gap-3 md:gap-4 w-full">
                            ...
                            <button
                                class="bg-[#275CAA] hover:bg-[#1d4f96] text-white px-8 py-2.5 rounded-lg text-sm font-medium transition-colors shadow-sm w-full sm:w-auto">
                                Browse
                            </button>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mt-2">
                            @for ($i = 0; $i < 8; $i++)
                                <div
                                    class="bg-[#F8FAFC] p-4 md:p-6 rounded-xl border border-gray-100 flex items-center justify-center text-center min-h-[80px] md:h-[100px] shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <div class="flex items-center justify-center gap-2 mt-8 md:mt-10">
                            ...
                            <div class="hidden sm:flex items-center gap-1">
                                @for ($i = 1; $i <= 10; $i++)
                                    <button
                                        class="w-8 h-8 flex items-center justify-center rounded text-sm font-medium transition-all {{ $i === 1 ? 'bg-[#275CAA] text-white' : 'hover:bg-gray-100 text-gray-700' }}">
                                        {{ $i }}
                                    </button>
                                @endfor
                            </div>
                            ...
                            <div class="sm:hidden flex items-center gap-2">
                                <button
                                    class="w-8 h-8 flex items-center justify-center rounded bg-[#275CAA] text-white font-medium text-sm">1</button>
